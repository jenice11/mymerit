                                        ...
                                        if ($result2->num_rows > 0) { 
                                            foreach ($data2 as $row) {
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        <td> <input class="form-control py-3" id="eventname" name="comittename" value="<?php echo $row['studName']?>" type="text" readonly placeholder="Enter comitte name" /></td>
                                                        <td><input class="form-control py-3" id="eventname" name="comittephone" value="<?php echo $row['studPhone']?>" type="text" readonly placeholder="Enter comitte phone" /></td>
                                                        <td><input class="form-control py-3" id="eventname" name="comittematric" value="<?php echo $row['studMatric']?>" type="text" readonly placeholder="Enter comitte matric" /></td>
                                                    </tr>
