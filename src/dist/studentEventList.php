                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="studentEventList.php">Event List</a>
                                            <a class="nav-link" href="#">Attendance</a>
                                            <a class="nav-link" href="#">Merit</a>
                                        </nav>
                                    </div>
                                </nav>
                            </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-1">
                                    ...
                                    <input type="button" class="primary-btn order-submit" onclick="location.href='studentViewEvent.php?progID=<?=$row['progID']?>'" value="VIEW DETAILS">&nbsp;
