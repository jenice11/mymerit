                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-1">
                                    <!-- <div class="card-header"><h3 class="text-center font-weight-light my-4">Event Lists</h3></div> -->
                                    <div class="card-body">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Total Merit</th>
                                            <th scope="col">Location</th>
                                            <th scope="col">Total Participants</th>
                                            <th scope="col">Event Proof</th> -->
                                    ...
                                    <input type="button" class="primary-btn order-submit" onclick="location.href='editEvent.php?progID=<?=$row['progID']?>'" value="EDIT">&nbsp;
                                    <input type="button" class="primary-btn order-submit" onclick="location.href='viewEvent.php?progID=<?=$row['progID']?>&studMatric=<?=$row['studMatric']?>'" value="VIEW">&nbsp;
                                    
                                    <input type="hidden" name="progID" value="<?=$row['progID']?>">
                                    <input class="primary-btn order-submit" type="submit" name="delete" value="DELETE">
                                    </form></td>
                                    <?php
                                            $i++;
                                            echo "</tr>";
