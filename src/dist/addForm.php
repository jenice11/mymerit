                                    ...
                                    <div class="card-body">
                                        <form method="POST" enctype='multipart/form-data' action="add.php">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="small mb-1" for="eventDesc">Committee</label><br>
                                                <select class="form py-5" id="committee" name="committee[]" multiple required="true">             
                                                ...
                                                <option value="<?php echo $row["studMatric"]; ?>" ><?php echo $row["studMatric"]; ?></option>                        
                                                <?php  }  
                                            } ?>
