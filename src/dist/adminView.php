                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="adminIndex.php">Program List</a>
                                            <a class="nav-link" href="approved.php">Approved Event</a>
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-1">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="form-row">
                                             ...
                                             <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <img src="<?="../proof/".$data['progProof']?>" alt="no_image" width="100" height="105" border="2"></td>
                                        ...
                                        <div class="form-row">
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                <input type="radio" name="ApprovalStatus" value="0">
                                                <label >
                                                    Reject
                                                </label>
                                                &nbsp &nbsp
