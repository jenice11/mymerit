...
$data = "SELECT * FROM program WHERE progApproval=1 ";
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                   <!--  <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pagesCollapseAuth" aria-expanded="false" aria-controls="pagesCollapseAuth">
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            <a class="nav-link" href="adminIndex.php">Event List</a>
            ...
            <div id="layoutSidenav_content">
               <main class="mb-3">
                    <div class="container-fluid">
                        <h1 class="mt-4">APPROVED EVENT</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Approved Event List</li>
                        </ol>
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-1">
                                    ...
                                    <input type="button" class="primary-btn order-submit" onclick="location.href='adminView.php?progID=<?=$row['progID']?>'" value="VIEW EVENT DETAILS">&nbsp;
